...
public class Messages {
  ...
  public enum RecordType {
    ...
    EXERCISE_EVENT_RECORD(13),
    EXERCISE_LAP_RECORD(14),
    EXERCISE_REPETITIONS_RECORD(15),
    EXERCISE_SESSION_RECORD(16),
    FLOORS_CLIMBED_RECORD(17),
    HEART_RATE_RECORD(18),
    HEART_RATE_VARIABILITY_DIFFERENTIAL_INDEX_RECORD(19),
    HEART_RATE_VARIABILITY_RMSSD_RECORD(20),
    HEART_RATE_VARIABILITY_SD2RECORD(21),
    HEART_RATE_VARIABILITY_SDANN_RECORD(22),
    HEART_RATE_VARIABILITY_SDNN_INDEX_RECORD(23),
    HEART_RATE_VARIABILITY_SDNN_RECORD(24),
    HEART_RATE_VARIABILITY_SDSD_RECORD(25),
    HEART_RATE_VARIABILITY_SRECORD(26),
    HEART_RATE_VARIABILITY_TINN_RECORD(27),
    HEIGHT_RECORD(28),
    HIP_CIRCUMFERENCE_RECORD(29),
    HYDRATION_RECORD(30),
    INTERMENSTRUAL_BLEEDING_RECORD(31),
    LEAN_BODY_MASS_RECORD(32),
    MENSTRUATION_FLOW_RECORD(33),
    NUTRITION_RECORD(34),
    OVULATION_TEST_RECORD(35),
    OXYGEN_SATURATION_RECORD(36),
    POWER_RECORD(37),
    RESPIRATORY_RATE_RECORD(38),
    RESTING_HEART_RATE_RECORD(39),
    SEXUAL_ACTIVITY_RECORD(40),
    SLEEP_SESSION_RECORD(41),
    SLEEP_STAGE_RECORD(42),
    SPEED_RECORD(43),
    STEPS_CADENCE_RECORD(44),
    STEPS_RECORD(45),
    SWIMMING_STROKES_RECORD(46),
    TOTAL_CALORIES_BURNED_RECORD(47),
    VO2MAX_RECORD(48),
    WAIST_CIRCUMFERENCE_RECORD(49),
    WEIGHT_RECORD(50),
    WHEELCHAIR_PUSHES_RECORD(51);
  ...
  public static class ActivityRecord {
    ...
    public @NonNull ExerciseId getExerciseType() { return exerciseType; }
    ...
    public @NonNull List<AggregationMetric> getMetrics() { return metrics; }
    ...
    public @NonNull Long getBegin() { return begin; }
    ...
    public @NonNull Long getEnd() { return end; }
    ...
    public @Nullable Metadata getMetadata() { return metadata; }
  ...
  public static class Metadata {
    ...
    public @NonNull String getOriginPackageName() { return originPackageName; }
    ...
    public @Nullable String getClientRecordId() { return clientRecordId; }
    ...
    public @NonNull Long getClientRecordVersion() { return clientRecordVersion; }
    ...
    public @NonNull Long getLastModifiedTime() { return lastModifiedTime; }
  ...
  public static class Device {
    ...
    public @Nullable String getManufacturer() { return manufacturer; }
    ...
    public @NonNull DeviceType getType() { return type; }
    ...
    static @NonNull Device fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setType(type == null ? null : DeviceType.values()[(int)type]);
      return pigeonResult;
    }
  }

  /** Generated class from Pigeon that represents data sent in messages. */
  public static class AggregationMetric {
    /** dataTypeName of AggregateMetric */
    private @NonNull MetricField field;
    public @NonNull MetricField getField() { return field; }
    ...
    public @NonNull MetricUnit getUnit() { return unit; }
    ...
    public @NonNull AggregationType getType() { return type; }
    ...
    static @NonNull AggregationMetric fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setField(field == null ? null : MetricField.values()[(int)field]);
      Object unit = list.get(1);
      pigeonResult.setUnit(unit == null ? null : MetricUnit.values()[(int)unit]);
      Object type = list.get(2);
      pigeonResult.setType(type == null ? null : AggregationType.values()[(int)type]);
  ...
  public static class RecordPermission {
    ...
    public @NonNull RecordType getType() { return type; }
    ...
    public @NonNull Boolean getReadonly() { return readonly; }
    ...
    static @NonNull RecordPermission fromList(@NonNull ArrayList<Object> list) {
      ...
      Object type = list.get(0);
      pigeonResult.setType(type == null ? null : RecordType.values()[(int)type]);
  ...
  public static class ConnectionCheckResult {
    ...
    public @NonNull HealthConnectStatus getStatus() { return status; }
    ...
    static @NonNull ConnectionCheckResult fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setStatus(status == null ? null : HealthConnectStatus.values()[(int)status]);
      return pigeonResult;
    }
  }
  ...
  public static class PermissionCheckResult {
    ...
    public @NonNull PermissionStatus getStatus() { return status; }
  ...
  private static class HealthConnectApiCodec extends StandardMessageCodec {
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof AggregationMetric) {
        stream.write(129);
        writeValue(stream, ((AggregationMetric) value).toList());
      } else 
      if (value instanceof ConnectionCheckResult) {
        stream.write(130);
      ...
      if (value instanceof PermissionCheckResult) {
        stream.write(134);
        writeValue(stream, ((PermissionCheckResult) value).toList());
      } else 
      if (value instanceof RecordPermission) {
        stream.write(135);
      ...
      } else 
{
  ...
  public interface HealthConnectApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, HealthConnectApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.HealthConnectApi.checkAvailability", getCodec());
        if (api != null) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.HealthConnectApi.hasAllPermissions", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.HealthConnectApi.getActivities", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
              ...
              if (startMillsEpochArg == null) {
                throw new NullPointerException("startMillsEpochArg unexpectedly null.");
              }
              Number endMillsEpochArg = (Number)args.get(1);
              if (endMillsEpochArg == null) {
                throw new NullPointerException("endMillsEpochArg unexpectedly null.");
              }
              Result<List<ActivityRecord>> resultCallback = new Result<List<ActivityRecord>>() {
