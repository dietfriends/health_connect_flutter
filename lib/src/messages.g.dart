...
class HealthConnectApi {
  ...
  static const MessageCodec<Object?> pigeonChannelCodec = _HealthConnectApiCodec();

  Future<ConnectionCheckResult> checkAvailability() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.health_connect.HealthConnectApi.checkAvailability';
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as ConnectionCheckResult?)!;
    }
  }

  Future<PermissionCheckResult> hasAllPermissions(List<RecordPermission?> expected) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.health_connect.HealthConnectApi.hasAllPermissions';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[expected]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
      ...
      return (__pigeon_replyList[0] as PermissionCheckResult?)!;
    }
  }

  Future<PermissionCheckResult> requestPermission(List<RecordPermission?> permissions) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.health_connect.HealthConnectApi.requestPermission';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<PermissionCheckResult> openHealthConnect(List<RecordPermission?> permissions) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.health_connect.HealthConnectApi.openHealthConnect';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<List<ActivityRecord?>> getActivities(int startMillsEpoch, int endMillsEpoch) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.health_connect.HealthConnectApi.getActivities';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[startMillsEpoch, endMillsEpoch]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<ActivityRecord?>();
    }
  }
}
